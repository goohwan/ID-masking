...
const MaskingWorkspace: React.FC<MaskingWorkspaceProps> = ({ imageFile, onReset }) => {
    ...
    if (status === 'processing' || status === 'idle') {
        return (
            <div className="flex flex-col items-center justify-center p-12 bg-gray-800 rounded-xl border border-gray-700">
                ...
                <p className="text-gray-400">Analyzing text and identifying sensitive data.</p>
    ...
    return (
        <div className="w-full max-w-6xl mx-auto">
            <div className="flex justify-between items-center mb-4">
                <h3 className="text-xl font-semibold text-white">Masking Workspace</h3>
                ...
                <div className="bg-gray-800 p-6 rounded-xl border border-gray-700 h-fit space-y-6">
                    <div>
                        ...
                        {maskingRegions.length === 0 ? (
                            <p className="text-gray-400 text-sm">No sensitive data automatically detected.</p>
                        ) : (
                    ...
                    <div className="pt-4 border-t border-gray-700">
                        <h4 className="text-sm font-medium text-gray-400 mb-2">Raw Text (Debug)</h4>
